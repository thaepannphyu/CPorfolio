...
const Contact = () => {
  ...
  return (
    <>
      ...
      {/* ipad view  */}
      <div
        className={`flex items-center justify-around h-[500px] max-[599px]:hidden min-[900px]:hidden`}>
        {/* information  */}
      ...
      {/* phone view */}
      <div className=" w-full mb-10 min-[600px]:hidden">
        <form className="w-full py-7 flex items-center justify-center">
          <div className={`flex flex-col mx-4 gap-7`}>
            ...
            <button
              onClick={() => setShow(!show)}
              className=" form-btn duration-500 text-gray-50 rounded-md font-bold font-sans px-8 py-3">
              Submit
            </button>
            <div className="flex flex-col gap-4">
