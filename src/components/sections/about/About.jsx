    ...
    <div>
        ...
        <div className=' w-[90%] mx-10 flex max-md:flex-col justify-between items-center max-xl:gap-10'>
            ...
            className=' w-[60%] max-md:w-[90%] flex  max-md:justify-center flex-col gap-3 '>
                <h1 className=' select-none max-md:text-center text-4xl max-lg:text-3xl font-bold text-[#ca1a95]'>ABOUT ME</h1>
                <p className=' select-none max-md:text-center text-xl max-[450px]:text-lg dark:text-[#e0f75b] text-blue-700'>Frontend Developer</p>
                <p className=' select-none max-md:text-center text-lg dark:text-[#4c6ef4] text-black max-[450px]:text-sm max-[600px]:hidden'>
                ...
                {/* ph view  */}
                <p className=' select-none max-md:text-center hidden text-lg dark:text-[#4c6ef4] text-black max-[450px]:text-sm max-[600px]:block'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod, ea est quibusdam architecto odio quos sunt, debitis ipsum rerum perferendis ipsam. Perspiciatis reiciendis voluptatum, consectetur dolores delectus repudiandae ex nobis.
                </p>
